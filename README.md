# UsuariosAPI
API de mentenimiento de usuarios.
...
- Las pruebas se pueden realizar en Swagger o usar Postman o aplicaciíon de preferencoa para realizar las peticiones
...
- login y GetAll accesibles
- Junto con el token del login probar los demás recursos (solo si usuario y contraseña son correctos)
- Las petciones se pueden realizar con la esructura solicitada
